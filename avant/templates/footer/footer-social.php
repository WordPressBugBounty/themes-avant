	...
	<div class="site-footer-icons">
        <div class="site-container">
			...
			if( get_theme_mod( 'avant-social-x' ) ) :
			    echo '<a href="' . esc_url( get_theme_mod( 'avant-social-x' ) ) . '" target="_blank" title="' . esc_attr__( 'Follow Us on X', 'avant' ) . '" class="footer-social-icon footer-social-x"><i class="fab fa-x-twitter"></i></a>';
			endif;
