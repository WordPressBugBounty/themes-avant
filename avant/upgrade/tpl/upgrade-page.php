    ...
    <div class="upgrade-page-inner-wrap">
        ...
        <div class="upgrade-page-top">
            ...
            <div class="upgrade-order-number-info-btns-link">
                <a href="https://kaira.lemonsqueezy.com/checkout/buy/f40e3470-5679-403a-9bae-4036a3af121c" class="upgrade-page-link" id="upgrade-purchase-link" target="_blank">
                    <?php printf( __( '<span>Avant Premium </span><em>$25</em>', 'avant' ) ); ?>
                </a>
                <p><?php esc_html_e( 'Once-off Payment, NO subscription', 'avant' ); ?></p>
            </div>
            
            <p class="avant-upgrade-p">
                <?php printf( __( 'Read more here on  <strong><a href="%1$s" target="_blank">what is included in Avant Premium</a></strong> or see <a href="%2$s" target="_blank"><b>how to install premium</b></a>', 'avant' ), 'https://kairaweb.com/go/what-premium-offers-page/', 'https://kairaweb.com/documentation/install-the-premium-theme/' ); ?>
            </p>
            <p class="avant-upgrade-p">
        ...
        <div class="upgrade-changelog">
            ...
            <p>See Readme.txt file for all changelogs</p>
        </div>
